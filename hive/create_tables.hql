...
CREATE DATABASE IF NOT EXISTS energy_fraud
  ...
  LOCATION 'hdfs://localhost:9000/data/energy';
...
CREATE EXTERNAL TABLE IF NOT EXISTS raw_readings (
    meter_id           STRING    COMMENT 'Unique meter identifier',
...
PARTITIONED BY (
    ...
    meter_id_part      STRING    COMMENT 'Partition: meter identifier'
)
STORED AS PARQUET
LOCATION 'hdfs://localhost:9000/data/energy/raw'
TBLPROPERTIES (
...
CREATE EXTERNAL TABLE IF NOT EXISTS meter_features (
    ...
    power_factor            DOUBLE,
    frequency_hz            DOUBLE,
    computed_power_w        DOUBLE    COMMENT 'Derived: V × I',
...
STORED AS PARQUET
LOCATION 'hdfs://localhost:9000/data/energy/processed'
TBLPROPERTIES (
    'parquet.compression'='SNAPPY',
    'discover.partitions'='true'
);
...
STORED AS PARQUET
LOCATION 'hdfs://localhost:9000/data/energy/alerts'
TBLPROPERTIES (
    'parquet.compression'='SNAPPY',
    'discover.partitions'='true'
);
